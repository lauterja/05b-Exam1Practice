...
def problem2a(circle, rectangle, window):
    ...
    line = rg.Line(rectangle.get_upper_left_corner(), rectangle.get_lower_left_corner())
    line.arrow = 'last'
...
def problem2b(rect, n, delta, win):
    ...
    for k in range(n - 1):
        ...
        corner2 = rg.Point(rect.get_upper_left_corner().x + delta, rect.get_upper_left_corner().y - delta)
